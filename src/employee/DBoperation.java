...
public class DBoperation {
    public static int write(String inname, String surname, String db, 
	    String salaryDate, int salaryAmt, int bonus, int koef, 
	    String phone, String addres, String dep) throws IOException {
	int id = 0;
